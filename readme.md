...
The 2nd is a modern cloud example where you will deploy to GKE. In both examples you will use MacOS as the client. There is more work than the local dev environment example but still fun stuff.
